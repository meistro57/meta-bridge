...
3. Tag how the claim is expressed:
...
4. surface_quote: 15 words MAX, a brief paraphrase or short direct excerpt showing where the claim lives in the passage. Prefer paraphrase.
5. Confidence (0.0-1.0): how certain you are this is a genuine extraction, not a stretch.
6. Tags: 1-4 short lowercase tags for the conceptual domain (e.g. "time", "identity", "substrate", "afterlife", "perception").
